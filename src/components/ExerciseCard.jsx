  ...
  return (
    <div className="p-4 rounded-md flex flex-col gap-4 bg-slate-950 sm:flex-wrap">
      <div className="flex flex-col sm:flex-row sm:items-center sm:flex-wrap gap-x-4">
        <h4 className="text-3xl hidden sm:inline sm:-4xl md:text-5xl font-semibold text-slate-400">
          0{index + 1}
        </h4>
        <h4 className="capitalize whitespace-nowrap truncate max-w-full text-lg sm:text-xl md:text-2xl flex-1 sm:text-center">
      ...
      <div className="grid grid-cols-2 sm:grid-colds-4 sm:place-items-center gap-2">
        ...
        >
          ...
          <p className="font-medium">{setsCompleted} / 6</p>
        </button>
      </div>
    </div>
  );
